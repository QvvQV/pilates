...
public class TestTwo {
    ...
    public static String url = "https://pilatesw1.tutorplace.ru/";
    ...
    public void ShouldGetTextFirstPage() {
        ...
        Assert.assertEquals("Секрет", PageVTwo.getSecret());
        Assert.assertEquals("стройности", PageVTwo.getSlimness());
        Assert.assertEquals("минус 2 размера за месяц с пилатесом!", PageVTwo.getPilates());
        Assert.assertEquals("Пройдите тест и сделайте первый шаг к стройности, всего за 1 рубль!", PageVTwo.getOneRub());
        Assert.assertEquals("Тест займет не более 2 минут!", PageVTwo.getTwoMinute());
        Assert.assertEquals("Укажите свой пол:", PageVTwo.setmFM());
        Assert.assertEquals("1/9", PageVTwo.getNumber());
        Assert.assertEquals("Женский", PageVTwo.getFemale());
        Assert.assertEquals("Мужской", PageVTwo.getMale());
        Assert.assertEquals("здоровая спина", PageVTwo.getBack());
        Assert.assertEquals("крепкие мышцы", PageVTwo.getMuskuls());
        Assert.assertEquals("похудение", PageVTwo.getWeight());
    }
