...
public class TestThree {
    ...
    public void ShouldGetTextFirstPage() {
        ...
        Assert.assertEquals("-10 см в талии", PageVThree.getMinus());
        Assert.assertEquals("за 2 недели", PageVThree.getWeek());
        Assert.assertEquals("тренируясь лежа на коврике!", PageVThree.getPilates());
        Assert.assertEquals("Завершите тест и получите свой план пилатеса бесплатно!", PageVThree.getBespl());
        Assert.assertEquals("Тест займет не более 2 минут!", PageVThree.getTwoMinute());
        Assert.assertEquals("Укажите свой пол:", PageVThree.setmFM());
        Assert.assertEquals("1/9", PageVThree.getNumber());
        Assert.assertEquals("Женский", PageVThree.getFemale());
        Assert.assertEquals("Мужской", PageVThree.getMale());
        Assert.assertEquals("здоровая спина", PageVThree.getBack());
        Assert.assertEquals("крепкие мышцы", PageVThree.getMuskuls());
        Assert.assertEquals("похудение", PageVThree.getWeight());
    }
    ...
    public void ShouldGetFuncFourthPage() {
        ...
        PageVThree.clickMale(); //PageVThree.clickFemale()
        Page2.clickQ2_1();
        Page3.clickQ3_1();
        Page4.clickQ4_1();
