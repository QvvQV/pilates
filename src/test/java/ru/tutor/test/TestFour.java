...
public class TestFour {
    ...
    public static String url = "https://pilatesw3.tutorplace.ru/";
    ...
    public void ShouldGetTextFirstPage() {
        ...
        Assert.assertEquals("Лежать и худеть", PageVFour.getMinus());
        Assert.assertEquals("Пройдите тест и получите персональный план пилатеса для похудения.", PageVFour.getPers());
        Assert.assertEquals("- реально с пилатесом Сбросьте до 7,6 кг за месяц", PageVFour.getPilates());
        Assert.assertEquals("всего за 1 рубль уже сейчас!", PageVFour.getOneRub());
        Assert.assertEquals("Тест займет не более 2 минут!", PageVFour.getTwoMinute());
        Assert.assertEquals("Укажите свой пол:", PageVFour.setmFM());
        Assert.assertEquals("1/9", PageVFour.getNumber());
        Assert.assertEquals("Женский", PageVFour.getFemale());
        Assert.assertEquals("Мужской", PageVFour.getMale());
        Assert.assertEquals("здоровая спина", PageVFour.getBack());
        Assert.assertEquals("крепкие мышцы", PageVFour.getMuskuls());
        Assert.assertEquals("похудение", PageVFour.getWeight());
    }
    ...
    public void ShouldGetFuncFourthPage() throws InterruptedException {
        ...
        PageVFour.clickMale(); //PageVFour.clickFemale()
        Page2.clickQ2_1();
        Page3.clickQ3_1();
        Page4.clickQ4_1();
