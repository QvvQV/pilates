...
public class Pay extends Driver {
    ...
    @FindBy(xpath = "//*[@id=\"order\"]/div/div/div[1]/h3")
    ...
    public static Object getFigure() {
        figure.getText().trim();
        return "Фигура мечты почти ваша! Успейте забрать тренировки пилатес по акции";
    }
...
//    }
    ...
    public static Object getDostup() {
        dostup.getText().trim();
        return "Только сейчас: получите доступ";
    }

    public static Object getOneRubl() {
        oneRubl.getText().trim();
        return "к курсу всего за 1 ₽*";
    }
